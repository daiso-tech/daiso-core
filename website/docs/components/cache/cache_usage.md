...
:::info
You can provide synchronous and asynchronous [`Invokable<[], Promiseable<TValue>>`](../../utilities/invokable.md) as default values for both `getOr` and `getOrAdd` methods.
:::
