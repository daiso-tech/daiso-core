 ...
 * @group Events
 */
export type MovedFileEvent = {
    source: IReadableFile;
    destination: IKey;
    replaced: boolean;
};
 ...
 * @group Events
 */
export type DestinationExistsFileEvent = {
    source: IReadableFile;
    destination: IKey;
};
...
export type FileEventMap = {
    ...
    [FILE_EVENTS.DESTINATION_EXISTS]: DestinationExistsFileEvent;
