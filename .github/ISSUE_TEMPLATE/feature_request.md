...
**Why can't this be an enhancement?**
Explain why your request cannot be addressed by adding an adapter, feature, or option to an existing component. Be specific about what makes this a fundamentally new component.

**Additional context**
Add any other context, code samples, or screenshots that would help us understand your request. If this relates to a specific framework or integration, mention it here.
